document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        if (!username || !password) {
            showCustomAlert("Username and password required", false);
            return;
        }
        ...
        try {
            ...
            if (response.ok) {
                showCustomAlert("Login successful! Redirecting to home...", true);
            } else {
    ...
    function showCustomAlert(message, autoRedirect) {
        ...
        button.textContent = autoRedirect ? "Go to Home Now" : "OK";
